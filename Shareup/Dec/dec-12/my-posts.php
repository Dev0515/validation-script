...
$PayRequestFields = array(
            ...
            'CancelURL' => 'https://example.com/cancel',                  // Required.  The URL to which the sender's browser is redirected if the sender cancels the approval for the payment after logging in to paypal.com.  1024 char max.
            ...
            'ReturnURL' => 'https://example.com/return',                  // Required.  The URL to which the sener's browser is redirected after approvaing a payment on paypal.com.  1024 char max.
            ...
            'SenderEmail' => 'ruby-facilitator@bytecodetechnologies.in',                // Sender's email address.  127 char max.
            'TrackingID' => ''                  // Unique ID that you specify to track the payment.  127 char max.
            );
            
$ClientDetailsFields = array(
            'CustomerID' => 'ruby-facilitator@bytecodetechnologies.in',                 // Your ID for the sender  127 char max.
...
$Receiver = array(
        ...
        'Email' => 'sanehthakur2443@gmail.com',                         // Receiver's email address. 127 char max.
...
$AccountIdentifierFields = array(
                'Email' => 'ruby-facilitator@bytecodetechnologies.in',                // Sender's email address.  127 char max.
                'Phone' => array('CountryCode' => '', 'PhoneNumber' => '4085494400', 'Extension' => '')               // Sender's phone number.  Numbers only.
                );
...
if($PayPalResult['PaymentExecStatus']=='COMPLETED'){ ?>
 <div class="share-text">
    <h4> Your paypal status : <?php echo $PayPalResult['PaymentExecStatus']; ?>.</h4>
...
<div class=" next-part">
<p>for test only
<a class="fancybox img<?php echo $id.$user->id;?>" rel="group" data-id="<?php echo $id.$user->id;?>" href="https://bytecodetechnologies.co.in/kevin-bendict/wp-content/uploads/2017/04/University-of-Washingotn-1.jpg" ><img height="100" width="100" src="https://bytecodetechnologies.co.in/kevin-bendict/wp-content/uploads/2017/04/University-of-Washingotn-1.jpg">	</a></p>
<p><?php echo get_post_meta($id,'applicants_message_'.$v,true); ?></p>
<?php 
$media_file = get_post_meta($id,'applicants_media_'.$v,true); 
$array_file = explode("," , $media_file);
//print_r($array_file);
foreach($array_file as $file)
{
	?>
	<a class="fancybox img<?php echo $id.$user->id;?>" rel="group" data-id="<?php echo $id.$user->id;?>" href="<?php echo $file;?>" ><img height="100" width="100" src="<?php echo $file?>">	</a>
<?php 
}
?>
...
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri()?>/fancybox/lib/jquery.mousewheel.pack.js"></script>

<!-- Add fancyBox -->
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri()?>/fancybox/source/jquery.fancybox.css?v=2.1.7" type="text/css" media="screen" />
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri()?>/fancybox/source/jquery.fancybox.pack.js?v=2.1.7"></script>
