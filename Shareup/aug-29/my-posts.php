...
<div class="release_confirm pop-up">
...
$query = new WP_Query( $args ); 
 ...
 echo '<div class="col-md-12 table_header-new"><h2 class="count_posts post-click">Posts ('.$query_posts->post_count.')</h2> <h2 class="count_posts hist-click">History ('.$query->post_count.')</h2> <span class="edit_right"><i class="fa fa-pencil" aria-hidden="true"></i></span><span class="done_right" style="display:none;">Done
...
<div class="col-md-2 col-xs-3" style=" color:#8cc53e ;" ><?php echo '$' . $budget;?></div>
...
<div class="col-md-2 col-xs-2"style=" color:#8cc53e ;"><?php echo '$' . $budget;?>
   </div>
  </div>
