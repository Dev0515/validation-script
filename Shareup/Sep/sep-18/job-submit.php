  ...
  <div class="text-side8">
    <form name="job_posting" action="" method="post" id="job_posting">
     <div id="sf1" class="frm">
        ...
        <div class="form-group" >
            ...
            <input type="text" name="budget"  id="budget" class="form-control" placeholder="$" required>
        </div>
        ...
        <label style="font-size:14px;font-weight:normal;">Where do you want to give? (i.e. your city of residence)</label>
			...
			<span id="location_error" class="help-inline-error"></span>
        </div>

	<div class="clearfix" style="clear: both;"></div>
     <div class="form-group">
       <label style="font-weight:normal;font-size:14px;">Category</label>                         
       ...
       <div class="form-group div-textarea" style="font-size:14px;">
        <label style="font-size:14px;font-weight:normal;">Who would you like to give your monetary aid to?<br>(You can choose to leave this blank, but your inbox requests may be larger than normal) </label>
         <textarea maxlength="140" id="textarea_job" name="description" class="share-textarea form-control" placeholder="Description"></textarea> 
       ...
       <div class="form-group">
        	<center>
              <div>
                <button class="btn  open1" id="job_submit" type="button" style="font-size:14px;font-weight:normal;">Post to Share</span></button> 
              </div>
             </center>
            </div>
          </fieldset>
		...
		<div class="form-group col-md-6">
			...
			<input id="fullname" class="form-control" name="fullname" readonly value="<?php echo $name; ?>" type="text" placeholder="John Smith" required/>
		</div>
    ...
    <div class="form-group col-md-6">
     ...
     <div class="form-group col-md-12">
        ...
        <center>
         <p style="width:40%;border:0;font-size:15px;" class="agree">
         	<div>* We charge a 12% fee on</div>
         	<div> any and all refunds</div>
         </p>
        </center>
         <p class="agree" style="border:0;width:70%;font-size:15px;">By posting you agree to our <a href="#">Terms of Use</a> and <a href="#">Privacy Policy</a></p>
      
      <!-- POST TO SHARE BUTTON -->
...
jQuery("#job_submit").click(function() {
				...
				success: function(text) {
					...
					if(res == '2')
					{
						...
						//alert("please select correct location");
						 ...
						 jQuery("#location_error").text('Please select correct location.');
