  ...
  <div id="black_overlay" style="width: 100%; visibility:hidden;"> 
    <div class="added pop-up">
      ...
      <form name="situation" action="" method="post" enctype="multipart/form-data">
        ...
        <input type="file" name="request_media[]" id="gallery-photo-add" class="input-file" multiple="multiple">  
...
else{$args1 = array('post_type'=>'task','posts_per_page'=>9,'paged' => $paged,'post_status'=>'publish');  
$args11 = array('post_type'=>'task','posts_per_page'=>9,'paged' => $paged ,'meta_query'=>
 array(array(
